...
import { SettingsLayout, SettingsGrid, SectionCard, NestedBox, NumberField, SETTINGS_NESTED } from '../../components/settings-blocks';
...
export function PathsSection({
  ...
  return (
    <SettingsLayout intro="Tell Kira where your media lives and where renamed files should land.">
      ...
      {/* Auto-scan + Per-type destinations — side by side. Both are
          self-contained config blocks; SettingsGrid's items-start keeps each
          sized to its own content (Auto-scan grows when expanded). */}
      <SettingsGrid>
